     ...
     >
       <Space>
         ...
         />
           ...
           <Form.Item>
             <Button className="btnForm" type="primary" onClick={prevStep}style={{width:"100px", position:"relative", top:"120px", left:"8px", backgroundColor:"#4F4A7B"}}>
               Previous
             </Button>
             <Button className="btnForm" type="primary"  htmlType="submit" onClick={openSecondModal} style={{width:"100px", position:"relative", top:"120px", left:"150px", backgroundColor:"#4F4A7B"}}>
               Submit
             </Button>
      ...
      <Modal
        ...
        footer={[ 
          <Button key="back" onClick={closeSecondModal}>Close</Button>
        ]}
      >
